...
CREATE DATABASE OficinaMecanicaFellipe;
Use OficinaMecanicaFellipe;
...
ALTER TABLE itens_servicos ADD COLUMN quantidade INT;
...
INSERT INTO ordem_servico (id_os, data_emissao, valor_total, status, id_veiculo, id_mecanico) VALUES
...
INSERT INTO itens_servicos (id_os, id_servico, quantidade) VALUES
...
# DESAFIO 1 :
# Apresente uma lista com o nome de todos os clientes e os modelos de seus veículos. Caso o cliente não tenha veículo cadastrado, o nome dele deve aparecer mesmo assim. 
...
# DESAFIO 2 :
# Quantas Ordens de Serviço cada mecânico realizou? Exiba o nome do mecânico e a contagem de OS.
...
# DESAFIO 4 :
#Liste o modelo do veículo, o nome do mecânico responsável e a descrição do serviço para todas as Ordens de Serviço que estejam com o status 'Aberto'. 
...
JOIN itens_servicos its ON os.id_os = its.id_os
JOIN servicos s ON its.id_servico = s.id_servico
WHERE os.status = 'Aberto';

# DESAFIO 5 :
# Liste os nomes dos clientes que gastaram em ordens de serviço um valor total acima da média de gastos de todos os clientes da oficina. 
